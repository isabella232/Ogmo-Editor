/* Originally written by Ludwig B: https://stackoverflow.com/a/6065769 */

using System;
using System.Drawing;
using System.Windows.Forms;

namespace OgmoEditor.Controls
{
	public class DraggableTabControl : TabControl
	{
		public delegate void TabSwapCallback(int srci, int dsti);
		public event TabSwapCallback OnTabSwap;

		public DraggableTabControl()
		{
			AllowDrop = true;

			MouseDown += tc_MouseDown;
			MouseUp += tc_MouseUp;
			MouseMove += tc_MouseMove;
			DragOver += tc_DragOver;
		}
